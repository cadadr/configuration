...
- =widget.gtk.overlay-scrollbars.enabled=
  ...
  - https://todon.eu/@maxi/108356307151802104

- =browser.tabs.unloadOnLowMemory=
  - =false=
  - do not unload tabs automatically/silently
  - https://firefox-source-docs.mozilla.org/browser/tabunloader/

- =mousewheel.default.delta_multiplier_y=
  - =1=
  - pixelwise scroll; by default firefox scrolls linewise and it's janky
    and inaccurate, terrible, in usual firefox fashion... this smoothens
    it a bit. smaller values make scrolling painfully slow unless the
    next two settings are set
