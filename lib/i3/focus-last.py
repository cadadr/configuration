# focus-last.py --- toggle focus between two recent windows in i3

# Adapted from https://github.com/altdesktop/i3ipc-python/blob/master/examples/focus-last.py

# The main difference here from the original script is that unique
# socket file name is ensured so that multiple i3 instances by the
# same or different user(s) will work nicely.
...
SOCKET_DIR = f'{tempfile.gettempdir()}/i3_focus_last.{os.geteuid()}{os.getenv("DISPLAY")}'
