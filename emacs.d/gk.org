#+title: Göktuğ's Emacs Configuration
...
(defvar gk-org-variable-pitch nil
  "When non-nil, use variable-pitch in Org-mode.
Run `org-mode' in the buffer for this to take effect after
setting it to t.")
#+END_SRC
...
(defun gk-org-visuals-hook ()
  ...
  (dotimes (n 7)
    (set-face-attribute
     ...
     :height (+ 40 gk-font-default-height))))
