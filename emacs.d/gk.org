...
#+CATEGORY: emacs.d
#+PROPERTY: header-args:elisp :edit-bindings '((lexical-binding t))
...
with a period, insert two spaces afterwards instead of one."
  ...
  (save-mark-and-excursion
    (let* ((para-beg
           ...
           (subs (buffer-substring para-beg para-end))
      ...
      (setq justify
            ...
            (if should-wrap
              ...
              (let ((right-edge-justified
                     (cl-reduce (lambda (x y) (= x y fill-column))
                ...
                (cond
                 ...
                 ;; If neither, then the paragrah is not justified.
                 ;; We can just allow ‘cond’ to return nil here.
                 ))))
      (case arg
        ((4 64)
         (setq justify nil)
